...
function xt_do_woocommerce_customizer_css() {
	...
	if( $woocommerce_menu_item_desktop !== 'hide' ) {
		...
		if( $woocommerce_menu_item_desktop_color ) {
			...
			echo '.xt-menu .xt-woo-menu-item .xt-woo-menu-item-count {';
			echo sprintf( 'background: %s;', esc_attr( $woocommerce_menu_item_desktop_color ) );
			echo '}';

			echo '.xt-menu .xt-woo-menu-item .xt-woo-menu-item-count:before {';
	...
	if( $woocommerce_menu_item_mobile !== 'hide' ) {
		...
		if( $woocommerce_menu_item_mobile_color ) {
			...
			echo '.xt-mobile-nav-wrapper .xt-woo-menu-item .xt-woo-menu-item-count {';
			echo sprintf( 'background: %s;', esc_attr( $woocommerce_menu_item_mobile_color ) );
			echo '}';

			echo '.xt-mobile-nav-wrapper .xt-woo-menu-item .xt-woo-menu-item-count:before {';
	...
	if( $woocommerce_loop_layout == 'list' ) {

		echo '@media (min-width: '. esc_attr( $breakpoint_mobile_int + 1 ) .'px) {';

			echo '.xt-woo-list-view .xt-woo-loop-thumbnail-wrapper {';
			echo 'float: left;';
			echo 'width: 48%;';
			echo '}';

			echo '.xt-woo-list-view .xt-woo-loop-summary {';
			echo 'float: right;';
			echo 'width: 48%;';
			echo '}';

			echo '.xt-woo-list-view.woocommerce ul.products li.product a img, .xt-woo-list-view ul.products li.product a img {';
	...
	if( $woocommerce_loop_image_alignment == 'right' ) {
	...
	if( $woocommerce_loop_image_width && $woocommerce_loop_image_width !== '50' ) {
	...
	if( $woocommerce_loop_out_of_stock_font_size || $woocommerce_loop_out_of_stock_font_color || $woocommerce_loop_out_of_stock_background_color ) {
		...
		echo '.woocommerce ul.products li.product .xt-woo-loop-out-of-stock {';
...
add_action( 'xt_after_customizer_css', 'xt_do_woocommerce_customizer_css', 10 );
