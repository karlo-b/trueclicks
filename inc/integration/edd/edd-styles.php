...
add_action( 'xt_after_customizer_css', 'xt_do_edd_customizer_css', 10 );

function xt_do_edd_customizer_css() {
	...
	if( $edd_menu_item_desktop !== 'hide' ) {
		...
		if( $edd_menu_item_desktop_color ) {
			...
			echo '.xt-menu .xt-edd-menu-item .xt-edd-menu-item-count {';
			echo sprintf( 'background: %s;', esc_attr( $edd_menu_item_desktop_color ) );
			echo '}';

			echo '.xt-menu .xt-edd-menu-item .xt-edd-menu-item-count:before {';
	...
	if( $edd_menu_item_mobile !== 'hide' ) {
		...
		if( $edd_menu_item_mobile_color ) {
			...
			echo '.xt-mobile-nav-wrapper .xt-edd-menu-item .xt-edd-menu-item-count {';
			echo sprintf( 'background: %s;', esc_attr( $edd_menu_item_mobile_color ) );
			echo '}';

			echo '.xt-mobile-nav-wrapper .xt-edd-menu-item .xt-edd-menu-item-count:before {';
